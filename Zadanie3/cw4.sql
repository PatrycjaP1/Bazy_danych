...
(2, 'Anita', 'Nowak', 'ul. Fio³kowa 5, Kraków', '987654321'),
(3, 'Piotr', 'Nowicki', 'ul. Kwiatowa 10, Gdañsk', '456123789'),
(4, 'Iwona', 'Lis', 'ul. Leœna 3, Poznañ', '321654987'),
(5, 'Piotr', 'Zieliñski', 'ul. Polna 8, Wroc³aw', '654987321'),
(6, 'Ewa', 'Wójcik', 'ul. S³oneczna 15, £ódŸ', '789654123'),
(7, 'Tomasz', 'Kaczmarek', 'ul. Morska 22, Szczecin', '159357246'),
(8, 'Karolina', 'D¹browska', 'ul. Zielona 7, Lublin', '369258147'),
(9, 'Mateusz', 'WoŸniak', 'ul. Jagodowa 12, Katowice', '852741963'),
(10, 'Aleksandra', 'Kubiak', 'ul. Górna 4, Bia³ystok', '741852963');
